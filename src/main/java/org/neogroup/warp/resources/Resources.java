    ...
    public static void register(String resourceName, Class<? extends Resource> resourceClass) {
        try {
            ...
            if (type instanceof ParameterizedType) {
                ...
                Controllers.registerRoute("GET", resourceName + "/:id", resourceController, resourceControllerClass.getDeclaredMethod("getResource", Request.class), RoutingPriority.NORMAL, false);
            }
        }
        catch (Exception ex) {
